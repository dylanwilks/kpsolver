...
fn random_sample_1() {
    ...
    let solution = items.clone().insert_into(knapsack).using(bounded_solvers::CPLEX);
    ...
    let solution_mut = items.insert_mut_into(knapsack_mut).using(bounded_solvers::CPLEX);
...
fn random_sample_2() {
    ...
    let solution = items.insert_into(knapsack).using(bounded_solvers::CPLEX);
...
fn random_sample_multi_knapsack_1() {
    ...
    let solution = items.clone().insert_into(knapsacks).using(bounded_solvers::CPLEX);
    ...
    let solution_mut = items.insert_mut_into(knapsacks_mut).using(bounded_solvers::CPLEX);
    assert_eq!(solution.value(), 2.0);
    assert_eq!(items[0].quantity, 1.0);
    assert_eq!(solution_mut[0].weights(), &[1.0]);
...
fn random_sample_multi_knapsack_2() {
    ...
    let solution = items.insert_into(knapsacks).using(bounded_solvers::CPLEX);
